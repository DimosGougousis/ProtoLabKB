...
category: trends
source_url: https://www.protolabs.com/resources/guides-and-trend-reports/product-development-trends/
fetched_at: 2026-04-21
summary: Product development trends for 2024 including time-to-market pressures, pandemic impacts, AI adoption, sustainability, and on-demand manufacturing.
---
...
**Takeaway**: This report is split into sections that define the current state of product development, investigate the factors that have shaped product development to date, and elaborate on the influences shaping product development during the next five years.

## Defining Product Development

As a digital manufacturer, we work with more than 50,000 developers annually to accelerate the product development process for the custom parts we produce for them. We use a range of manufacturing methods at our factories in the U.S. and beyond to build custom parts for our customers, and also provide a manufacturing network to connect our customers to additional production services.

So, let's start with how we define product development. We work with customers from the earliest stage of prototyping through market launch and ongoing production to help them iterate faster and scale up production in response to demand.

Taking this holistic view, in a poll we conducted in the fourth quarter of 2023, we surveyed 767 engineers and designers— from companies of all sizes, and from a variety of industries—for a deeper dive into product development. Our goal was to examine the forces that have shaped product development as it stands today, and to take the pulse of the innovators who are bringing products to market as we move through the new year and beyond.
...
**Takeaway**: The amount of time and the related urgent need for speed are the biggest product development barriers to success across all stages, from prototyping through production.
...
**Takeaway**: The pandemic continued to influence product development. Though actual COVID-19 case numbers are down significantly in the U.S., pandemic-induced obstacles persisted for product developers, including material shortages, supply chain disruptions, reduced staff/resources, and limited in-house production capacity.
...
What about artificial intelligence? AI is a headline-worthy emerging technology, but the majority of product developers don't think that it is mature enough to have a major effect on product development with 66% saying it would have little to no impact over the next five years.
...
**Takeaway**: Product developers are cautiously optimistic about moving beyond the pandemic. The perceived state of the economy and now-familiar issues with supply chains, staffing, and material shortages, however, remain top-of-mind.
